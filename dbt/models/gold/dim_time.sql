...
time_values AS (
    ...
    FROM time_series
    --You get 1,440 rows, like:
    -- minute_number	time_key	actual_time	hour	minute	ampm	market_period
    -- 0	            0000	    12:00 AM	0	    0	    AM	    Closed
    -- 570	            0930	    09:30 AM	9	    30	    AM	    Regular Hours
    -- 960	            1600	    4:00 PM	    16	    0	    PM	    Regular Hours
    -- 1100	            1820	    06:20 PM	18	    20	    PM	    Post-Market
)
SELECT
    minute_number,
    time_and_day,
