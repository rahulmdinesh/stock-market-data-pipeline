...
if not API_KEY:
    logger.error("The environment variable FINNHUB_API_KEY has not been set!")
    exit(1)
BASE_URL = "https://finnhub.io/api/v1/quote"
SYMBOLS = ["AMZN", "PANW", "NVDA", "AMD", "TSM", "AAPL"]
...
def is_market_open() -> bool:
    """Check whether the US stock market is currently open based on Eastern Time."""
...
class ResilientKafkaProducer:
    ...
    def _connect(self):
        ...
        logger.info("Waiting for Kafka to become ready...")
        time.sleep(10)
        ...
        while True:
            ...
            if is_market_open():
                ...
                for symbol in SYMBOLS:
                    ...
                    logger.info(f"Quote result for {symbol}: {quote}")  
                    if quote:
                        logger.info(f"Sending {symbol} to Kafka") 
