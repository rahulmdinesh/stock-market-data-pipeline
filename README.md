...
GRANT ALL PRIVILEGES ON ALL SCHEMAS IN DATABASE STOCKS TO ROLE DATA_PIPELINE_ROLE;
GRANT ALL PRIVILEGES ON FUTURE SCHEMAS IN DATABASE STOCKS TO ROLE DATA_PIPELINE_ROLE;
